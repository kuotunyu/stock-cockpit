...
> **這份記錄工程面稽核**（XSS、持久化、auth、無障礙、程式品質）。
> **股票／金融專業面**（計算正確性、回測與前向驗證方法論、台股市場結構、金額與時點語意）
> 另見 **[`DOMAIN-BACKLOG.md`](DOMAIN-BACKLOG.md)**——2026-07-26 稽核：已完成 6 條，
> 待辦 32 條分三層（明確錯誤 12、需拍板 14、待查證與已知限制 6）。
