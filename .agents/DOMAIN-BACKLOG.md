...
| 第二層 D-20～D-33 | **1 完成 / 13 待決** | 真實缺陷，但修法牽涉口徑選擇 |
...
**下一步建議**：D-20 已採「毛淨並陳」完成。接著可評估 **D-25**（RR 門檻要不要改用淨值——會改變入選標的，需與 D-02／D-11 一起升版本號）、**D-27**（勝率最小樣本門檻，需決定門檻數字）、**D-22**（帳本不處理除權減資，工程量最大但除權日的假虧損最明顯）。
