...
test("更多頁：九顆 tile 分「看盤設定」「帳號與維護」兩組；靜態殼也已補齊九顆（2026-09-16 移除「版本與更新」）", () => {
  const result = json(`(() => {
  ...
  assert.deepEqual(result.order, ["glossary", "source", "risk", "alerts", "mobile", "system", "backup", "brokerGuide", "notesFeed"]);
});
